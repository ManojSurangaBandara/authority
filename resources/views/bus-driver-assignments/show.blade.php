                ...
                <div class="card card-teal">
                    <div class="card-header">
                        ...
                        <div class="card-tools">
                            <a href="{{ route('bus-driver-assignments.edit', $bus_driver_assignment->id) }}"
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                @if ($bus_driver_assignment->busRoute && $bus_driver_assignment->busRoute->bus)
                                                    <br><small
                                                        class="text-muted">{{ $bus_driver_assignment->busRoute->bus->name }}
                                                        ({{ $bus_driver_assignment->busRoute->bus->type->name ?? 'N/A' }})</small>
                                                @endif
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                @if ($bus_driver_assignment->busRoute && $bus_driver_assignment->busRoute->bus)
                                                    <span
                                                        class="badge badge-primary">{{ $bus_driver_assignment->busRoute->bus->no }}</span>
                                                @else
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered table-striped">
                                        <tr>
                                            ...
                                            <td><span
                                                    class="badge badge-info">{{ $bus_driver_assignment->driver->identification ?? $bus_driver_assignment->driver_regiment_no }}</span>
                                            </td>
                                        </tr>
                                        <tr>
                                            <th>Rank</th>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a
                                                    href="tel:{{ $bus_driver_assignment->driver_contact_no }}">{{ $bus_driver_assignment->driver_contact_no }}</a>
                                            </td>
                                        </tr>
                                    </table>
                                </div>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="info-box">
                                            ...
                                            <div class="info-box-content">
                                                ...
                                                <span
                                                    class="info-box-number">{{ $bus_driver_assignment->assigned_date->format('d M Y') }}</span>
                                                <div class="progress">
                                    ...
                                    <div class="col-md-4">
                                        <div class="info-box">
                                            <span
                                                class="info-box-icon bg-{{ $bus_driver_assignment->end_date ? 'warning' : 'secondary' }}">
                                            ...
                                            <div class="info-box-content">
                                                ...
                                                <div class="progress">
                                                    <div class="progress-bar bg-{{ $bus_driver_assignment->end_date ? 'warning' : 'secondary' }}"
                                                        style="width: 100%"></div>
                                                </div>
                                                <span class="progress-description">
                                                    @if ($bus_driver_assignment->end_date)
                                    ...
                                    <div class="col-md-4">
                                        <div class="info-box">
                                            ...
                                            <div class="info-box-content">
                                                ...
                                                <span class="info-box-number">
                                                    @if ($bus_driver_assignment->end_date)
                                                        {{ $bus_driver_assignment->assigned_date->diffInDays($bus_driver_assignment->end_date) }}
                                                        days
                                                    @else
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered table-sm">
                                        <tr>
                                            ...
                                            <td>{{ $bus_driver_assignment->created_at->format('d M Y, h:i A') }}
                                                ({{ $bus_driver_assignment->created_at->diffForHumans() }})</td>
                                        </tr>
                                        <tr>
                                            <th>Last Updated</th>
                                            <td>{{ $bus_driver_assignment->updated_at->format('d M Y, h:i A') }}
                                                ({{ $bus_driver_assignment->updated_at->diffForHumans() }})</td>
                                        </tr>
                    ...
                    <div class="card-footer">
                        <div class="row">
                            ...
                            <div class="col-md-6 text-right">
                                <form action="{{ route('bus-driver-assignments.destroy', $bus_driver_assignment->id) }}"
