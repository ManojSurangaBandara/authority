                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select id="driver_type" name="driver_type"
                                            ...
                                            <option value="Army" {{ old('driver_type') == 'Army' ? 'selected' : '' }}>Army
                                            </option>
                                            <option value="Civil" {{ old('driver_type') == 'Civil' ? 'selected' : '' }}>
                                                Civil</option>
                                        </select>
                                        @error('driver_type')
                                            <span class="invalid-feedback">{{ $message }}</span>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input type="text"
                                                ...
                                                {{ old('driver_type', 'Army') == 'Army' ? 'required' : '' }}>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('driver_nic') is-invalid @enderror"
                                            id="driver_nic" name="driver_nic" value="{{ old('driver_nic') }}"
                                            placeholder="Enter NIC" {{ old('driver_type') == 'Civil' ? 'required' : '' }}>
                                        @error('driver_nic')
                                            <span class="invalid-feedback">{{ $message }}</span>
                                        @enderror
                                    </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('driver_rank') is-invalid @enderror"
                                        id="driver_rank" name="driver_rank" value="{{ old('driver_rank') }}"
