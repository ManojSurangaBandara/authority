                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route('persons.update', $person->id) }}" method="POST" id="personForm">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="rank" id="rank" required
                                                class="form-control" value="{{ old('rank', $person->rank) }}">
                                            @error('rank')
                                                <div class="text-danger">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="unit" id="unit" required
                                                class="form-control" value="{{ $person->unit }}">
                                            @error('unit')
                                                <div class="text-danger">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="nic" id="nic" required
                                                class="form-control" value="{{ $person->nic }}">
                                            @error('nic')
                                                <div class="text-danger">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="army_id" id="army_id" required
                                                class="form-control" value="{{ $person->army_id }}">
                                            @error('army_id')
                                                <div class="text-danger">{{ $message }}</div>
                                            @enderror
                                        </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea name="permanent_address" id="permanent_address" required class="form-control" rows="3">{{ $person->permanent_address }}</textarea>
                                    ...
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="telephone_no" id="telephone_no" required
                                                class="form-control" value="{{ $person->telephone_no }}">
                                            <small class="form-text text-muted">This field can be edited manually</small>
                                            @error('telephone_no')
                                                <div class="text-danger">{{ $message }}</div>
                                            @enderror
                                    ...
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="grama_seva_division" id="grama_seva_division"
                                                required class="form-control" value="{{ $person->grama_seva_division }}">
                                            <small class="form-text text-muted">This field can be edited manually</small>
                                    ...
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="nearest_police_station"
                                                ...
                                                value="{{ $person->nearest_police_station }}">
                                            <small class="form-text text-muted">This field can be edited manually</small>
