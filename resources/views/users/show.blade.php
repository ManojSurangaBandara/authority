                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if ($user->email_verified_at)
                                            ...
                                            <small
                                                class="text-muted d-block">{{ $user->email_verified_at->format('M d, Y H:i') }}</small>
                                        @else
            ...
            return ucfirst($parts[count($parts) - 1] ?? 'General');
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    @foreach ($permissions as $permission)
                                        <span
                                            class="badge badge-secondary badge-sm mr-1 mb-1">{{ $permission->name }}</span>
                                    @endforeach
                                </div>
                            @endforeach
                        </div>
                                    ...
                                    <details>
                                        ...
                                        <div class="mt-2">
                                            @foreach ($role->permissions as $permission)
                                                <span
                                                    class="badge badge-light badge-sm mr-1 mb-1">{{ $permission->name }}</span>
                                            @endforeach
                                        </div>
                                    </details>
                                @endif
