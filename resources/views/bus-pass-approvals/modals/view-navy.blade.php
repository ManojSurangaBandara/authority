        ...
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">
                    ...
                    Navy Bus Pass Application #{{ $application->id }}
                    <span class="badge badge-primary ml-2">Navy</span>
                </h4>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <table class="table table-sm">
                            ...
                            <tr>
                                <td><strong>Navy ID:</strong></td>
                                <td>{{ $application->person->navy_id }}</td>
                            </tr>
                            <tr>
                ...
                @if ($application->bus_pass_type === 'unmarried_daily_travel')
                    <div class="row mt-3">
                        <div class="col-12">
                            ...
                            @if (isset($canEditRoute) && $canEditRoute)
                                <form id="routeUpdateFormUnmarriedDailyTravel">
                                    <input type="hidden" name="application_id" value="{{ $application->id }}">
                                    <div class="mb-3">
                                        <div class="form-row">
                                            <div class="col-md-6">
                                        ...
                                        <div class="form-row mt-2">
                                            <div class="col-12">
                                                <button type="button" id="updateRouteBtnUnmarriedDailyTravel"
                                                    class="btn btn-primary">
                                                    <i class="fas fa-save"></i> Update Route
                                                </button>
                                            </div>
                                            ...
                                            <form id="routeUpdateFormWeekendMonthly">
                                                ...
                                                <div class="mb-3">
                                                    <div class="form-row">
                                                        ...
                                                        <div class="col-md-6">
                                                            <label for="destination_location_ahq_readonly">Destination
                                                                Location from
                                                                AHQ:</label>
                                                            <input type="text" class="form-control form-control-sm"
                                                                value="{{ $application->destination_location_ahq }}"
                                                                readonly>
                                                        </div>
                                                    </div>
                                                    <div class="form-row mt-2">
                                                        ...
                                                        <div class="col-md-6">
                                                            <label for="weekend_destination_readonly">Weekend
                                                                Destination:</label>
                                                            <input type="text" class="form-control form-control-sm"
                                                                value="{{ $application->weekend_destination }}"
                                                                readonly>
                                                        </div>
                                                    </div>
                                                    <div class="form-row mt-2">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @if ($application->grama_niladari_certificate)
                                                    ...
                                                    <small class="text-success ml-2"><i
                            ...
                            @if (!$isViewOnly ?? false)
                                @if (auth()->user()->can('approve_bus_pass'))
                                    ...
                                    @elseif (auth()->user()->hasRole('Subject Clerk (DMOV)'))
                                        ...
                                        <button type="button" class="btn btn-success" data-dismiss="modal"
                                            data-toggle="modal" data-target="#approveModal{{ $application->id }}">
        ...
        @if (isset($canEditRoute) && $canEditRoute)
            <script>
                $(document).ready(function() {
                    ...
                    // Handle route update for unmarried daily travel
                    $('#updateRouteBtnUnmarriedDailyTravel').on('click', function() {
                        updateRoute('#routeUpdateFormUnmarriedDailyTravel');
                    });
