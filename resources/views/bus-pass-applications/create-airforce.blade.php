                ...
                <div class="card mt-3">
                    <div class="card card-teal">
                        <div class="card-header">
                            <i class="nav-icon fas fa-id-card nav-icon"></i> {{ __('New Airforce Bus Pass Application') }}
                        </div>

                        <form action="{{ route('bus-pass-applications.store') }}" method="POST"
                            enctype="multipart/form-data" id="busPassForm">
                            @csrf
                            <input type="hidden" name="application_type" value="airforce">
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label for="airforce_id">Airforce ID <span class="text-danger">*</span></label>
                                            <input type="text"
                                                class="form-control @error('airforce_id') is-invalid @enderror"
                                                id="airforce_id" name="airforce_id" value="{{ old('airforce_id') }}"
                                                required>
                                            @error('airforce_id')
                                                <span class="invalid-feedback">{{ $message }}</span>
                                            @enderror
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control @error('blood_group') is-invalid @enderror"
                                                ...
                                                @foreach (['A+', 'A-', 'B+', 'B-', 'O+', 'O-', 'AB+', 'AB-'] as $grp)
                                                    <option value="{{ $grp }}"
                                                        {{ old('blood_group') === $grp ? 'selected' : '' }}>{{ $grp }}
                                                    </option>
                                                @endforeach
                                            </select>
                                            @error('blood_group')
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="permission_letter">Letter of Permission from the Head of
                                                Establishment
                                                <span class="text-info">(For Unmarried Daily Travel only)</span> <span
                                                    class="text-danger">*</span></label>
                                            <input type="file"
