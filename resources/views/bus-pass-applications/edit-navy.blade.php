                ...
                <div class="card mt-3">
                    <div class="card card-teal">
                        <div class="card-header">
                            <i class="nav-icon fas fa-id-card nav-icon"></i> {{ __('Edit Navy Bus Pass Application') }}
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                ...
                                                name="navy_id"
                                                value="{{ old('navy_id', $bus_pass_application->person->navy_id) }}"
                                                required>
                                            @error('navy_id')
                                                <span class="invalid-feedback">{{ $message }}</span>
                                            @enderror
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control @error('blood_group') is-invalid @enderror"
                                                ...
                                                @foreach (['A+', 'A-', 'B+', 'B-', 'O+', 'O-', 'AB+', 'AB-'] as $grp)
                                                    <option value="{{ $grp }}"
                                                        {{ old('blood_group', $bus_pass_application->person->blood_group ?? '') === $grp ? 'selected' : '' }}>
                                                        {{ $grp }}</option>
                                                @endforeach
                                            </select>
                                            @error('blood_group')
