...
@section('title', 'New Civil Bus Pass Application')

@section('content_header')
    <div class="row">
        <div class="col-sm-6">
            <h1><i class="fas fa-user-plus"></i> New Civil Bus Pass Application</h1>
        </div>
        <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item active">Create Civil Application</li>
            </ol>
        </div>
    </div>
@stop
                ...
                <div class="card mt-3">
                    <div class="card card-teal">
                        <div class="card-header">
                            <i class="nav-icon fas fa-user-plus nav-icon"></i> {{ __('New Civil Bus Pass Application') }}
                        </div>
                            ...
                            <div class="card-body">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                ...
                                                name="civil_id" value="{{ old('civil_id') }}" required
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="date"
                                                ...
                                                value="{{ old('date_arrival_ahq') }}" max="{{ date('Y-m-d') }}"
                                                required>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control @error('obtain_sltb_season') is-invalid @enderror"
                                                ...
                                                <option value="yes"
                                                    {{ old('obtain_sltb_season') == 'yes' ? 'selected' : '' }}>Yes
                                                </option>
                                                <option value="no"
                                                    {{ old('obtain_sltb_season') == 'no' ? 'selected' : '' }}>No
                                                </option>
                                            </select>
                                ...
                                <div id="unmarried_daily_travel_section" style="display: none;">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="requested_bus_name_unmarried">Requested Bus Name <span
                                                        class="text-danger">*</span></label>
                                ...
                                <div id="weekend_monthly_section" style="display: none;">
                                    <div class="row">
                                        <div class="col-12">
                                            <h5 class="text-info mb-3">Living in Person - Weekend/Monthly Traveling
                                            </h5>
                                        </div>
                                    </div>
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="destination_location_ahq">Destination Location from
                                                    AHQ <span class="text-danger">*</span></label>
                                ...
                                <div id="living_in_only_section" style="display: none;">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="destination_location_living_in">Destination Location from
                                                    AHQ
                                                    (Living in) <span class="text-danger">*</span></label>
                                        ...
                                        <div class="form-group">
                                            <label for="marriage_part_ii_order_daily">Marriage Part II Order
                                                <span class="text-info">(For Married Personnel - Not applicable for
                                                    Living
                                                    in Bus only)</span> <span class="text-danger">*</span></label>
                                            <input type="file"
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="permission_letter">Letter of Permission from the Head of
                                                Establishment
                                                <span class="text-info">(For Unmarried Daily Travel
                                                    only)</span> <span class="text-danger">*</span></label>
                                            <input type="file"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="person_image">Person Image <span
                                                    class="text-danger">*</span></label>
                                            <input type="file"
                                        ...
                                        <div class="form-group">
                                            <div class="form-check">
                                                ...
                                                <label class="form-check-label" for="declaration_1">
                                                    The applicant have declared that the information provided above is
                                                    true
                                                    and correct to the
                                        ...
                                        <div class="form-group">
                                            <div class="form-check">
                                                ...
                                                <label class="form-check-label" for="declaration_2">
                                                    The applicant understands that any false information may result in
                                                    the
                                                    rejection of
