                ...
                <div class="card mt-3">
                    <div class="card card-teal">
                        <div class="card-header">
                            <i class="nav-icon fas fa-id-card nav-icon"></i> {{ __('Edit Airforce Bus Pass Application') }}
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                ...
                                                id="airforce_id" name="airforce_id"
                                                value="{{ old('airforce_id', $bus_pass_application->person->airforce_id) }}"
                                                required>
                                            @error('airforce_id')
                                                <span class="invalid-feedback">{{ $message }}</span>
                                            @enderror
