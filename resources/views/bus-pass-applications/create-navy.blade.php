                ...
                <div class="card mt-3">
                    <div class="card card-teal">
                        <div class="card-header">
                            <i class="nav-icon fas fa-id-card nav-icon"></i> {{ __('New Navy Bus Pass Application') }}
                        </div>

                        <form action="{{ route('bus-pass-applications.store') }}" method="POST"
                            enctype="multipart/form-data" id="busPassForm">
                            @csrf
                            <input type="hidden" name="application_type" value="navy">
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label for="navy_id">Navy ID <span class="text-danger">*</span></label>
                                            <input type="text"
                                                class="form-control @error('navy_id') is-invalid @enderror" id="navy_id"
                                                name="navy_id" value="{{ old('navy_id') }}" required>
                                            @error('navy_id')
                                                <span class="invalid-feedback">{{ $message }}</span>
                                            @enderror
                                        </div>
