                        ...
                        <form action="{{ route('bus-pass-applications.update', $bus_pass_application) }}" method="POST"
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                   ...
                                   <div class="form-group">
                                    <label for="gs_division">Grama Seva Division <span class="text-danger">*</span></label>
                                      <select class="form-control @error('gs_division') is-invalid @enderror"
                                        id="gs_division"
                                        name="gs_division"
                                        required>
                                       <option value="">-- Select Division --</option>
                                        ...
                                        {{ old('gs_division', $bus_pass_application->person->gs_division_id) == $division->id ? 'selected' : '' }}>
                                        {{ $division->name }}
                                        </option>
                                        @endforeach
                                       </select>
