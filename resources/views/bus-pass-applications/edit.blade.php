            ...
            <div class="col-md-12">
                ...
                <div class="card mt-3">
                    <div class="card card-teal">
                        ...
                        <form action="{{ route('bus-pass-applications.update', $application) }}" method="POST" enctype="multipart/form-data" id="busPassForm">
                            @csrf
                            @method('PUT')
                            <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <input type="text" class="form-control @error('regiment_no') is-invalid @enderror"
                                       id="regiment_no" name="regiment_no" value="{{ old('regiment_no', $application->regiment_no) }}" required>
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('rank') is-invalid @enderror"
                                   id="rank" name="rank" value="{{ old('rank', $application->rank) }}" required>
                            @error('rank')
                                <span class="invalid-feedback">{{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('name') is-invalid @enderror"
                                   id="name" name="name" value="{{ old('name', $application->name) }}" required>
                            @error('name')
                                <span class="invalid-feedback">{{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('unit') is-invalid @enderror"
                                   id="unit" name="unit" value="{{ old('unit', $application->unit) }}" required>
                            @error('unit')
                                <span class="invalid-feedback">{{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('nic') is-invalid @enderror"
                                   id="nic" name="nic" value="{{ old('nic', $application->nic) }}" required>
                            @error('nic')
                                <span class="invalid-feedback">{{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('army_id') is-invalid @enderror"
                                   id="army_id" name="army_id" value="{{ old('army_id', $application->army_id) }}" required>
                            @error('army_id')
                                <span class="invalid-feedback">{{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <textarea class="form-control @error('permanent_address') is-invalid @enderror"
                                      id="permanent_address" name="permanent_address" rows="3" required>{{ old('permanent_address', $application->permanent_address) }}</textarea>
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('telephone_no') is-invalid @enderror"
                                   id="telephone_no" name="telephone_no" value="{{ old('telephone_no', $application->telephone_no) }}" required>
                            @error('telephone_no')
                                <span class="invalid-feedback">{{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('grama_seva_division') is-invalid @enderror"
                                   id="grama_seva_division" name="grama_seva_division" value="{{ old('grama_seva_division', $application->grama_seva_division) }}" required>
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('nearest_police_station') is-invalid @enderror"
                                   id="nearest_police_station" name="nearest_police_station" value="{{ old('nearest_police_station', $application->nearest_police_station) }}" required>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('branch_directorate') is-invalid @enderror"
                                   id="branch_directorate" name="branch_directorate" value="{{ old('branch_directorate', $application->branch_directorate) }}" required>
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="date" class="form-control @error('date_arrival_ahq') is-invalid @enderror"
                                   ...
                                   value="{{ old('date_arrival_ahq', $application->date_arrival_ahq ? $application->date_arrival_ahq->format('Y-m-d') : '') }}" required>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <select class="form-control @error('approval_living_out') is-invalid @enderror"
                                ...
                                <option value="yes" {{ old('approval_living_out', $application->approval_living_out) == 'yes' ? 'selected' : '' }}>Yes</option>
                                <option value="no" {{ old('approval_living_out', $application->approval_living_out) == 'no' ? 'selected' : '' }}>No</option>
                            </select>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <select class="form-control @error('obtain_sltb_season') is-invalid @enderror"
                                ...
                                <option value="">Select</option>
                                <option value="yes" {{ old('obtain_sltb_season', $application->obtain_sltb_season) == 'yes' ? 'selected' : '' }}>Yes</option>
                                <option value="no" {{ old('obtain_sltb_season', $application->obtain_sltb_season) == 'no' ? 'selected' : '' }}>No</option>
                            </select>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <select class="form-control @error('bus_pass_type') is-invalid @enderror"
                                ...
                                <option value="daily_travel" {{ old('bus_pass_type', $application->bus_pass_type) == 'daily_travel' ? 'selected' : '' }}>Daily Travel</option>
                                <option value="weekend_monthly_travel" {{ old('bus_pass_type', $application->bus_pass_type) == 'weekend_monthly_travel' ? 'selected' : '' }}>Weekend/Monthly Travel</option>
                            </select>
                            @error('bus_pass_type')
                                <span class="invalid-feedback">{{ $message }}</span>
                            @enderror
                    ...
                    <div class="row">
                                ...
                                <select class="form-control" id="requested_bus_name" name="requested_bus_name">
                                    ...
                                    @if(isset($busRoutes))
                                        @foreach($busRoutes as $route)
                                            <option value="{{ $route->name }}" {{ old('requested_bus_name', $application->requested_bus_name) == $route->name ? 'selected' : '' }}>{{ $route->name }}</option>
                                        @endforeach
                                    @endif
                                </select>
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="destination_from_ahq" name="destination_from_ahq" value="{{ old('destination_from_ahq', $application->destination_from_ahq) }}">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select class="form-control" id="living_in_bus" name="living_in_bus">
                                    ...
                                    <option value="Kinnadeniya 1" {{ old('living_in_bus', $application->living_in_bus) == 'Kinnadeniya 1' ? 'selected' : '' }}>Kinnadeniya 1</option>
                                    <option value="Kinnadeniya 2" {{ old('living_in_bus', $application->living_in_bus) == 'Kinnadeniya 2' ? 'selected' : '' }}>Kinnadeniya 2</option>
                                    <option value="Kinnadeniya 3" {{ old('living_in_bus', $application->living_in_bus) == 'Kinnadeniya 3' ? 'selected' : '' }}>Kinnadeniya 3</option>
                                    <option value="Panagoda - Officers" {{ old('living_in_bus', $application->living_in_bus) == 'Panagoda - Officers' ? 'selected' : '' }}>Panagoda - Officers</option>
                                    <option value="Panagoda - Other Ranks" {{ old('living_in_bus', $application->living_in_bus) == 'Panagoda - Other Ranks' ? 'selected' : '' }}>Panagoda - Other Ranks</option>
                                    <option value="Kandalanda" {{ old('living_in_bus', $application->living_in_bus) == 'Kandalanda' ? 'selected' : '' }}>Kandalanda</option>
                                    <option value="Pamankada" {{ old('living_in_bus', $application->living_in_bus) == 'Pamankada' ? 'selected' : '' }}>Pamankada</option>
                                    <option value="Maharagama" {{ old('living_in_bus', $application->living_in_bus) == 'Maharagama' ? 'selected' : '' }}>Maharagama</option>
                                    <option value="Mathegoda" {{ old('living_in_bus', $application->living_in_bus) == 'Mathegoda' ? 'selected' : '' }}>Mathegoda</option>
                                    <option value="SLEME - Kompanyaweediya" {{ old('living_in_bus', $application->living_in_bus) == 'SLEME - Kompanyaweediya' ? 'selected' : '' }}>SLEME - Kompanyaweediya</option>
                                    <option value="Rathmalaana" {{ old('living_in_bus', $application->living_in_bus) == 'Rathmalaana' ? 'selected' : '' }}>Rathmalaana</option>
                                    <option value="Other" {{ old('living_in_bus', $application->living_in_bus) == 'Other' ? 'selected' : '' }}>Other</option>
                                </select>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select class="form-control" id="destination_location_ahq" name="destination_location_ahq">
                                    ...
                                    <option value="Panagoda" {{ old('destination_location_ahq', $application->destination_location_ahq) == 'Panagoda' ? 'selected' : '' }}>Panagoda</option>
                                    <option value="Kandalanda" {{ old('destination_location_ahq', $application->destination_location_ahq) == 'Kandalanda' ? 'selected' : '' }}>Kandalanda</option>
                                    <option value="Maharagama" {{ old('destination_location_ahq', $application->destination_location_ahq) == 'Maharagama' ? 'selected' : '' }}>Maharagama</option>
                                    <option value="Kinnadeniya" {{ old('destination_location_ahq', $application->destination_location_ahq) == 'Kinnadeniya' ? 'selected' : '' }}>Kinnadeniya</option>
                                    <option value="Pamankada" {{ old('destination_location_ahq', $application->destination_location_ahq) == 'Pamankada' ? 'selected' : '' }}>Pamankada</option>
                                    <option value="Mathegoda" {{ old('destination_location_ahq', $application->destination_location_ahq) == 'Mathegoda' ? 'selected' : '' }}>Mathegoda</option>
                                    <option value="SLEME Workshop" {{ old('destination_location_ahq', $application->destination_location_ahq) == 'SLEME Workshop' ? 'selected' : '' }}>SLEME Workshop</option>
                                    <option value="Rathmalaana" {{ old('destination_location_ahq', $application->destination_location_ahq) == 'Rathmalaana' ? 'selected' : '' }}>Rathmalaana</option>
                                    <option value="Other" {{ old('destination_location_ahq', $application->destination_location_ahq) == 'Other' ? 'selected' : '' }}>Other</option>
                                </select>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select class="form-control" id="weekend_bus_name" name="weekend_bus_name">
                                    ...
                                    @if(isset($busRoutes))
                                        @foreach($busRoutes as $route)
                                            <option value="{{ $route->name }}" {{ old('weekend_bus_name', $application->weekend_bus_name) == $route->name ? 'selected' : '' }}>{{ $route->name }}</option>
                                        @endforeach
                                    @endif
                                </select>
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="weekend_destination" name="weekend_destination" value="{{ old('weekend_destination', $application->weekend_destination) }}">
                            </div>
                        </div>
                    </div>
                </div>
