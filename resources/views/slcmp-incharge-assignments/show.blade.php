                ...
                <div class="card card-teal">
                    <div class="card-header">
                        ...
                        <div class="card-tools">
                            ...
                            <a href="{{ route('slcmp-incharge-assignments.edit', $slcmpInchargeAssignment->id) }}"
                                        ...
                                        <dl class="row">
                                            ...
                                            <dd class="col-sm-8">
                                                ...
                                                @if ($slcmpInchargeAssignment->busRoute)
                                                    <br><small
                                                        class="text-muted">{{ $slcmpInchargeAssignment->busRoute->description }}</small>
                                                @endif
                                            </dd>
                                            ...
                                            <dd class="col-sm-8">
                                                @if ($slcmpInchargeAssignment->busRoute && $slcmpInchargeAssignment->busRoute->bus)
                                                    <span
                                                        class="badge badge-primary">{{ $slcmpInchargeAssignment->busRoute->bus->no }}</span>
                                                    <br><small
                                            ...
                                            <dd class="col-sm-8">
                                                {{ $slcmpInchargeAssignment->assigned_date ? $slcmpInchargeAssignment->assigned_date->format('d M Y') : 'N/A' }}
                                            </dd>

                                            <dt class="col-sm-4">End Date:</dt>
                                            <dd class="col-sm-8">
                                                {{ $slcmpInchargeAssignment->end_date ? $slcmpInchargeAssignment->end_date->format('d M Y') : 'Not Set' }}
                                            </dd>
                                ...
                                <div class="card card-outline card-success">
                                    ...
                                    <div class="card-body">
                                        <dl class="row">
                                            ...
                                            <dd class="col-sm-8">
                                                <strong>{{ $slcmpInchargeAssignment->slcmp_regiment_no }}</strong></dd>
                                            ...
                                            <dd class="col-sm-8">
                                                <strong>{{ $slcmpInchargeAssignment->slcmp_name }}</strong></dd>

                                            <dt class="col-sm-4">Contact No:</dt>
                                            <dd class="col-sm-8">
                                                @if ($slcmpInchargeAssignment->slcmp_contact_no)
                                                    <a href="tel:{{ $slcmpInchargeAssignment->slcmp_contact_no }}"
                                                        class="text-primary">
                                                        <i class="fas fa-phone"></i>
                                                        {{ $slcmpInchargeAssignment->slcmp_contact_no }}
                                                    </a>
                                                @else
                                ...
                                <div class="card card-outline card-warning">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-md-3">
                                                <div class="info-box bg-info">
                                                    ...
                                                    <div class="info-box-content">
                                                        ...
                                                        <span
                                                            class="info-box-number">{{ $slcmpInchargeAssignment->assigned_date ? $slcmpInchargeAssignment->assigned_date->format('d M Y') : 'N/A' }}</span>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-3">
                                                <div class="info-box bg-warning">
                                                    ...
                                                    <div class="info-box-content">
                                                        ...
                                                        <span
                                                            class="info-box-number">{{ $slcmpInchargeAssignment->end_date ? $slcmpInchargeAssignment->end_date->format('d M Y') : 'Ongoing' }}</span>
                                                    </div>
                                                </div>
                                            </div>
                                                        ...
                                                        <span class="info-box-number">
                                                            @if ($slcmpInchargeAssignment->assigned_date)
                                                                @if ($slcmpInchargeAssignment->end_date)
                                                                    {{ $slcmpInchargeAssignment->assigned_date->diffInDays($slcmpInchargeAssignment->end_date) }}
                                                                    days
                                                                @else
                                                                    {{ $slcmpInchargeAssignment->assigned_date->diffInDays(now()) }}
                                                                    days
                                                                @endif
                                                            @else
                                                                N/A
                                            ...
                                            <div class="col-md-3">
                                                <div
                                                    class="info-box bg-{{ $slcmpInchargeAssignment->status == 'active' ? 'success' : 'secondary' }}">
                                                    <span class="info-box-icon"><i
                                                            class="fas fa-{{ $slcmpInchargeAssignment->status == 'active' ? 'check-circle' : 'pause-circle' }}"></i></span>
                                                    <div class="info-box-content">
                                                        <span class="info-box-text">Status</span>
                                                        <span
                                                            class="info-box-number">{{ ucfirst($slcmpInchargeAssignment->status) }}</span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="card card-outline card-secondary">
                                    ...
                                    <div class="card-body">
                                        <dl class="row">
                                            ...
                                            <dd class="col-sm-4">
                                                {{ $slcmpInchargeAssignment->created_at ? $slcmpInchargeAssignment->created_at->format('d M Y, h:i A') : 'N/A' }}
                                            </dd>

                                            <dt class="col-sm-2">Last Updated:</dt>
                                            <dd class="col-sm-4">
                                                {{ $slcmpInchargeAssignment->updated_at ? $slcmpInchargeAssignment->updated_at->format('d M Y, h:i A') : 'N/A' }}
                                            </dd>
                                        </dl>
                                    </div>
                                </div>
                    ...
                    <div class="card-footer">
                        ...
                        <form action="{{ route('slcmp-incharge-assignments.destroy', $slcmpInchargeAssignment->id) }}"
