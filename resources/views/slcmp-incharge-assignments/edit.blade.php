        ...
        <div class="row">
            <div class="col-12">
                <div class="card card-teal">
                    ...
                    <form action="{{ route('slcmp-incharge-assignments.update', $slcmpInchargeAssignment->id) }}"
                        method="POST" id="slcmpAssignmentForm">
                        @csrf
                        @method('PUT')
                        <div class="card-body">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('slcmp_rank') is-invalid @enderror"
                                            id="slcmp_rank" name="slcmp_rank"
                                            value="{{ old('slcmp_rank', $slcmpInchargeAssignment->slcmp_rank) }}"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('slcmp_name') is-invalid @enderror"
                                            id="slcmp_name" name="slcmp_name"
                                            value="{{ old('slcmp_name', $slcmpInchargeAssignment->slcmp_name) }}"
                                            placeholder="Auto-filled from API" readonly required>
                                        @error('slcmp_name')
                                            <span class="invalid-feedback">{{ $message }}</span>
                                        @enderror
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="date"
                                            ...
                                            value="{{ old('assigned_date', $slcmpInchargeAssignment->assigned_date ? $slcmpInchargeAssignment->assigned_date->format('Y-m-d') : '') }}"
                                            required>
                                        @error('assigned_date')
                                            <span class="invalid-feedback">{{ $message }}</span>
                                        @enderror
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control @error('status') is-invalid @enderror" id="status"
                                            ...
                                            <option value="active"
                                                {{ old('status', $slcmpInchargeAssignment->status) == 'active' ? 'selected' : '' }}>
                                                Active</option>
                                            <option value="inactive"
                                                {{ old('status', $slcmpInchargeAssignment->status) == 'inactive' ? 'selected' : '' }}>
                                                Inactive</option>
                                        </select>
                                        @error('status')
                                            <span class="invalid-feedback">{{ $message }}</span>
                        ...
                        <div class="card-footer">
                            ...
                            <a href="{{ route('slcmp-incharge-assignments.show', $slcmpInchargeAssignment->id) }}"
                                class="btn btn-info">
