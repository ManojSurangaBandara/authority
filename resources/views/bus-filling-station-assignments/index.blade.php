...
@section('content_header')
    <div class="row mb-2">
        <div class="col-sm-6">
            <h1><i class="fas fa-gas-pump"></i> Bus Filling Station Assignments</h1>
        </div>
    </div>
@stop
        ...
        <div class="col-12">
            <div class="card card-teal">
                <div class="card-header">
                    <h3 class="card-title">
                        <i class="fas fa-gas-pump"></i> Bus Filling Station Assignments
                    </h3>
                    <div class="card-tools">
                        <a href="{{ route('bus-filling-station-assignments.create') }}" class="btn btn-secondary btn-sm">
                            <i class="fas fa-plus"></i> Assign Filling Station
                        </a>
                    </div>
                </div>
