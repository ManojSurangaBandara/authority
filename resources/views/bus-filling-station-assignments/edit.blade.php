        ...
        <div class="row">
            <div class="col-12">
                <div class="card card-teal">
                    ...
                    <form action="{{ route('bus-filling-station-assignments.update', $busFillingStationAssignment->id) }}"
                        method="POST" id="busFillingStationForm">
                        @csrf
                        @method('PUT')
                        <div class="card-body">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control @error('status') is-invalid @enderror" id="status"
                                            ...
                                            <option value="active"
                                                {{ old('status', $busFillingStationAssignment->status) == 'active' ? 'selected' : '' }}>
                                                Active</option>
                                            <option value="inactive"
                                                {{ old('status', $busFillingStationAssignment->status) == 'inactive' ? 'selected' : '' }}>
                                                Inactive</option>
                                        </select>
                                        @error('status')
                                            <span class="invalid-feedback">{{ $message }}</span>
                        ...
                        <div class="card-footer">
                            ...
                            <a href="{{ route('bus-filling-station-assignments.show', $busFillingStationAssignment->id) }}"
                                class="btn btn-info">
