...
@section('title', 'Living Out Passenger Counts Report')

@section('content_header')
    <div class="row">
        <div class="col-sm-6">
            <h1><i class="fas fa-chart-bar"></i> Living Out Passenger Counts Report</h1>
        </div>
        <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">Dashboard</a></li>
                <li class="breadcrumb-item"><a href="{{ route('passenger-counts.index') }}">Passenger Counts</a></li>
                <li class="breadcrumb-item active">Living Out</li>
            </ol>
        </div>
    </div>
@stop
            ...
            <div class="col-12">
                ...
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">
                            <i class="fas fa-bus"></i> Living Out Route-wise Passenger Counts by Personnel Type
                        </h3>
                                        ...
                                        <tr>
                                            <td colspan="8" class="text-center">
                                                <div class="alert alert-info mb-0">
                                                    ...
                                                    No living out route data available
                                                </div>
                                            </td>
                                        </tr>
                                    @endforelse
...
@section('js')
    <script>
        ...
        function exportToExcel() {
            ...
            a.href = url;
            a.download = 'living-out-passenger-counts-report-' + new Date().toISOString().slice(0, 10) + '.csv';
