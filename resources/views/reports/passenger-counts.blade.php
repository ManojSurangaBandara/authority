...
@section('title', 'Passenger Counts Report')

@section('content_header')
    <div class="row">
        <div class="col-sm-6">
            <h1><i class="fas fa-chart-bar"></i> Passenger Counts Report</h1>
        </div>
        <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">Dashboard</a></li>
                <li class="breadcrumb-item"><a href="#">Reports</a></li>
                <li class="breadcrumb-item active">Passenger Counts</li>
            </ol>
        </div>
    </div>
@stop
            ...
            <div class="col-12">
                ...
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">
                            <i class="fas fa-bus"></i> Route-wise Passenger Counts by Personnel Type
                        </h3>
...
@section('js')
    <script>
        ...
        function exportToExcel() {
            ...
            a.href = url;
            a.download = 'passenger-counts-report-' + new Date().toISOString().slice(0, 10) + '.csv';
