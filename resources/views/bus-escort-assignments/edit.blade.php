...
@section('title', 'Edit Bus Escort Assignment')

@section('content_header')
    <div class="row mb-2">
        <div class="col-sm-6">
            <h1><i class="fas fa-shield-alt"></i> Edit Bus Escort Assignment</h1>
        </div>
    </div>
@stop
            ...
            <div class="col-12">
                <div class="card card-teal">
                    <div class="card-header">
                        <i class="nav-icon fas fa-shield-alt nav-icon"></i> {{ __('Edit Bus Escort Assignment') }}
                    ...
                    <form action="{{ route('bus-escort-assignments.update', $assignment->id) }}" method="POST" id="busEscortAssignmentForm">
                        @csrf
                        @method('PUT')
                        <div class="card-body">
                                        ...
                                        <select class="form-control @error('bus_route_id') is-invalid @enderror"
                                            ...
                                            @foreach ($busRoutes as $route)
                                                <option value="{{ $route->id }}"
                                                    {{ (old('bus_route_id', $assignment->bus_route_id) == $route->id) ? 'selected' : '' }}>
                                                    {{ $route->name }}
                                                </option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="form-control" id="bus_no_display" style="background-color: #f8f9fa;">
                                            @if($assignment->busRoute && $assignment->busRoute->busNo)
                                                <strong>{{ $assignment->busRoute->busNo }}</strong><br>
                                                <small class="text-muted">{{ $assignment->busRoute->bus_name }} ({{ $assignment->busRoute->bus_type }})</small>
                                            @else
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input type="text"
                                                ...
                                                value="{{ old('escort_regiment_no', $assignment->escort_regiment_no) }}"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text"
                                            ...
                                            name="escort_rank" value="{{ old('escort_rank', $assignment->escort_rank) }}"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text"
                                            ...
                                            name="escort_name" value="{{ old('escort_name', $assignment->escort_name) }}"
                                            placeholder="Auto-filled from API" readonly required>
                                        @error('escort_name')
                                            <span class="invalid-feedback">{{ $message }}</span>
                                        @enderror
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text"
                                            ...
                                            value="{{ old('escort_contact_no', $assignment->escort_contact_no) }}"
