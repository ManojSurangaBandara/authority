            ...
            <div class="col-md-7">
                ...
                <div class="card mt-3">
                    <div class="card card-teal">
                        <div class="card-header"><i class="nav-icon fas fa-building"></i> {{ __('Add New Establishment') }}
                        </div>
                        <div class="card-body">
                            <form action="{{ route('establishment.store') }}" method="POST" id="establishmentForm">
                                @csrf
                                ...
                                <div class="mb-3">
                                    ...
                                    <small class="text-muted">Selected: <span
                                            id="establishment_selected">None</span></small>
