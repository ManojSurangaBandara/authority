...
Route::middleware('auth')->group(function () {
    ...
    Route::post('bus-pass-approvals/{application}/clearance', [BusPassApprovalController::class, 'clearance'])->name('bus-pass-approvals.clearance');
    ...
    Route::get('clearance-applications', [ReportController::class, 'clearance'])->name('clearance-applications.index');
    ...
    Route::get('report-establishment-wise-applications', [ReportController::class, 'establishmentWiseApplications'])->name('establishment-wise-applications.index');
    ...
    Route::get('trips/{id}/map', [ReportController::class, 'tripMap'])->name('trips.map');
    Route::get('trips/{id}/locations', [ReportController::class, 'getTripLocations'])->name('trips.locations');
