...
return new class extends Migration
{
    ...
    {
        DB::statement("ALTER TABLE bus_pass_approval_histories MODIFY COLUMN action ENUM('approved', 'rejected', 'forwarded', 'recommended', 'not_recommended', 'dmov_not_recommended', 'forwarded_to_branch_clerk') NOT NULL");
    }
};
