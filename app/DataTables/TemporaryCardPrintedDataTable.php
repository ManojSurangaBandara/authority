...
class TemporaryCardPrintedDataTable extends DataTable
{
    /**
    ...
    {
        $query = $model->newQuery()->with(['person.rank', 'establishment'])->whereIn('status', ['temp_card_printed', 'temp_card_handed_over']);
