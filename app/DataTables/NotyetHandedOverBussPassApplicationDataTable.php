...
class NotyetHandedOverBussPassApplicationDataTable extends DataTable
{
    /**
    ...
    {
        $query = $model->newQuery()->with(['person.rank', 'establishment'])->where('status', 'temp_card_printed');
