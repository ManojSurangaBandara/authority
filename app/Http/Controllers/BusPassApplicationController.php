    ...
    public function store(Request $request)
    {
        ...
        if ($applicationType === 'civil') {
            $validationRules = [
                ...
                'nok_telephone_no' => 'nullable|string|max:20',
    ...
    public function update(Request $request, BusPassApplication $bus_pass_application)
    {
        ...
        if ($applicationType === 'civil') {
            $validationRules = [
                ...
                'branch_card_id' => $request->branch_card_availability === 'has_branch_card' ? 'required|string|max:50' : 'nullable|string|max:50',
                'date_arrival_ahq' => 'required|date',
                'grama_niladari_certificate' => ($request->bus_pass_type !== 'living_in_only') ? (!$bus_pass_application->grama_niladari_certificate ? 'required|file|mimes:pdf,jpg,jpeg,png|max:10240' : 'nullable|file|mimes:pdf,jpg,jpeg,png|max:10240') : 'nullable|file|mimes:pdf,jpg,jpeg,png|max:10240',
