...
use App\DataTables\ClearanceApplicationsDataTable;
...
class ReportController extends Controller
{
    ...
    public function clearance(ClearanceApplicationsDataTable $dataTable)
    {
        // Filter establishments for branch users
        $user = Auth::user();
        $branchRoles = ['Bus Pass Subject Clerk (Branch)', 'Staff Officer (Branch)', 'Director (Branch)'];
        ...
        return $dataTable->render('reports.clearance-applications', compact('establishments'));
    }
